...
# Jacob Friedberg
# Version 1.0
SRCS = scanner.l parser.y ourgetopt.cpp Tree.cpp symbolTable.cpp
HDRS = scanType.h ourgetopt.h Tree.h symbolTable.h
OBJS = lex.yy.o parser.tab.o ourgetopt.o Tree.o symbolTable.o
BIN  = c-
CC   = g++
